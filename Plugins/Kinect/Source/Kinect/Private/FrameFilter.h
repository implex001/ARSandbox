...
class FrameFilter
	...
	/* Embedded classes: */
	public:
	typedef UINT16 RawDepth; // Data type for raw depth values
	...
	mutable FCriticalSection inputFrameMutex; // Mutex protecting the input frame
...
public:
	Kinect::FrameBuffer& filterThreadMethod(void); // Method for the background filtering thread
	
	/* Constructors and destructors: */
	public:
	FrameFilter(const unsigned int sSize[2],unsigned int sNumAveragingSlots); // Creates a filter for frames of the given size and the given running average length
